...
|   C4.5    | Discrete & Continueous |    Entropy, IV, Gain Ratio    | **PEP, REP** |    Allowed    |
|   CHAID   | Discrete & Continueous |    Chisquare Test p value     |      ?       |       ?       |
|   CART    | Discrete & Continueous |       Gini Index, MSE         | Predicted ER |       ?       |
|   QUEST   | Discrete & Continueous |  Chisquare / F Test p value   | Predicted ER |       ?       |
...
# library(pROC)
# roc.ID3 <- roc(response = training[,Y_attribute],
#                predictor = as.numeric(pred.ID3.train),
#                plot = F)
# 
# plot(roc.ID3, 
#      print.auc=TRUE, 
...
# library(pROC)
# roc.C45 <- roc(response = training[,Y_attribute],
#                predictor = as.numeric(pred.C45.train),
#                plot = F)
# 
# plot(roc.C45, 
#      print.auc=TRUE, 
